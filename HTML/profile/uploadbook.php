...
<div id="upload-book-popup" class="popup">
      <div class="popup-content">
        ...
        <form id="upload-book-form" action="" method="post" enctype="multipart/form-data" autocomplete="off">
          ...
          <input type="text" id="author-name" name="author-name" placeholder="Author Name" >
          <input type="text" id="genre" name="genre" placeholder="genre" >
          <input type="number" id="published-year" name="published-year" min="1900" max="2099" placeholder="Publication Year" >
          <input type="text" id="book-publisher" name="book-publication" placeholder="publication" >
          <input type="radio" id="donate-radio" name="price-type" value="donate" onclick="togglePriceFields(false)" >
          <label for="donate-radio">Donate</label>
          <input type="radio" id="sale-radio" name="price-type" value="sale" onclick="togglePriceFields(true)" >
          <label for="sale-radio">Sale</label>
          <div class="price-fields">
            <input type="number" id="actual-price" name="actual-price" placeholder="Actual Price" >
